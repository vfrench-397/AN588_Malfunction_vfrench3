---
title: "vfrench3_OriginalHomeworkCode_04"
...
#C: This is some really great code and I've learned a bunch from it! I definitely struggled with part 1 a lot lol. The comments make it really easy to follow, and I didn't even think about testing if the functions worked, good idea!I don't have many comments as it seems to run great. 
...
```
#C: smart of you to estimate B0 and B1 up here to check if they align with the model 
...
g
```
#C: realizing I forgot to put the Lm eq into my ggplot
...
```
#I used unlist here instead to extract my coefs, but this way works too
```{r}
...
beta1 
```
#C: looks good, this is the formula I used too
Interpretation: 
...
```
#C: I didn't think of this, need to go back and incorporate it
Interpretation: 
...
```
#C: Nice, I did things a little different but they both function the same way 
...
g
```
#C: this looks good, you didn't have to keep assigning g <- g though, could have just used the +
...
```
#C: looks good, same as mine, also very good interpretations in general 
...
#C: log model looks the same as the original, so all my original comments stand
# Challenges
...
#C: I think this was my biggest struggle 
...
#C: still a good idea to remove the NAs before using the data set for anything

#C: overall this is really great! You've definitely made me realize a few things I am missing, thank you!